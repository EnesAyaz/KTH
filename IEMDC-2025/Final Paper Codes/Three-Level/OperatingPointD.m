...
if n==1
resistance= 1.0255*max(v_a)*power_factor/max(i_a);
elseif n==1.5
resistance= 1.0255*max(v_a)*power_factor/max(i_a);
elseif n==2
resistance= 1.0255*max(v_a)*power_factor/max(i_a);
...
if n==1
resistance= 1.0335*max(v_a)*power_factor/max(i_a);
elseif n==1.5
resistance= 1.0335*max(v_a)*power_factor/max(i_a);
elseif n==2
resistance= 1.0335*max(v_a)*power_factor/max(i_a);
...
if n==1
theta2=theta2-(pi+theta_difference)+0.4320; % findind dq update
elseif n==1.5
theta2=theta2-(pi+theta_difference)+0.4320; % findind dq update
elseif n==2
theta2=theta2-(pi+theta_difference)+0.4320; % findind dq update
...
if cmode=='3rd1' % reference common-mode injection 
if n==1
theta2=theta2-(pi+theta_difference)+0.435; % findind dq update
elseif n==1.5
theta2=theta2-(pi+theta_difference)+0.435; % findind dq update
elseif n==2
theta2=theta2-(pi+theta_difference)+0.435; % findind dq update
