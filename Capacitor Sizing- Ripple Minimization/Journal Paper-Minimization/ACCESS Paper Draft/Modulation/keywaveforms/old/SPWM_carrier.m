...
hold on;
cf=plot(time_array,VcarrierA,'Linewidth',0.5,'Color',[0.8 0 0],'LineStyle','-')
% cf.Color= [cf.Color 1]

cf=plot(time_array,VcarrierB,'Linewidth',0.5,'Color',[0 0.8 0],'LineStyle','-')
% cf.Color= [cf.Color 1]

cf=plot(time_array,VcarrierC,'Linewidth',0.5,'Color',[0 0 0.8],'LineStyle','-')
% cf.Color= [cf.Color 1]
...
hold on;
plot(time_array,VcarrierA,'Linewidth',1,'Color',[0.8 0 0],'LineStyle','-')

plot(time_array,VcarrierB,'Linewidth',1,'Color',[0 0.8 0],'LineStyle','-')

plot(time_array,VcarrierC,'Linewidth',1,'Color',[0 0 0.8],'LineStyle','-')
...
legend1 = legend(axes1,'show',{'$Ref_A$','$Ref_B$','$Ref_C$','$Car_A$','$Car_B$','$Car_C$'},'FontName','TimesNewRoman','FontSize',20);
set(legend1,...
