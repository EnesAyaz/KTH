...
for j in range(12):put('C'+str(j+1),170+(j%6)*39,45+(j//6)*33)
text('C1-C6 ABOVE RIGHT CELL; C7-C12 BELOW LEFT CELL. ALL COMPONENTS ON TOP FACE.',150,99,1.1)
...
(OUT/(NAME+'.kicad_sch')).write_text('\n'.join(['(kicad_sch (version 20230121) (generator eeschema)',f'(uuid {sheet})','(paper "A3")','(title_block (title "Four EPC2361 onboard-driver prototype") (rev "P2") (date "2026-09-21"))','(lib_symbols '+''.join(defs)+')',*items,'(sheet_instances (path "/" (page "1")))',')']))
