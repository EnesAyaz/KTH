...
source=(ROOT/'scripts/route_p5.py').read_text();exec(source[source.index('step=.1'):source.index('failed=[]')])
...
for n,start,star,ends in [('HO',(37.25,37.6),(52.2,31),[(43.19,31.5),(61.19,31.5)]),('LO',(35.75,37.6),(52.2,40),[(43.19,35.7),(61.19,35.7)])]:
 try:
  ...
  for index,end in enumerate(ends):
   waypoints=[star,end]
   if n=='HO' and index==0:waypoints=[star,(52.2,32.9),(44.5,32.9),(44.5,31.5),end]
