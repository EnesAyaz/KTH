...
(OUT/(NAME+'.kicad_sch')).write_text('\n'.join(['(kicad_sch (version 20230121) (generator eeschema)',f'(uuid {sheet})','(paper "A3")','(title_block (title "Four EPC2361 onboard-driver prototype") (rev "P4") (date "2026-09-22"))','(lib_symbols '+''.join(defs)+')',*items,'(sheet_instances (path "/" (page "1")))',')']))
