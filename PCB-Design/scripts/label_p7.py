...
label('EPC2361 / TWO PER SWITCH / P7',59,8,size=.9)
label('24 x 1uF 100V / ALL CAPS TOP',59,11,size=.9,fixed=True)
label('REVIEW PROTOTYPE',54,54,size=.9,fixed=True)
label('DC+',39,9,size=.9)
label('DC-',39,16,size=.9)
label('LK1 / QL1 CURRENT',51,16,size=.8)
