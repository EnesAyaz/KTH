...
hold on;
cf=plot(time_array,VcarrierA,'Linewidth',1.5,'Color','k')
cf.Color= [cf.Color 1]
...
plot(time_array,SA+1.5,'Linewidth',3,'Color','b')
hold on;
plot(time_array,SB,'Linewidth',3,'Color','m')
hold on;
plot(time_array,SC-1.5,'Linewidth',3,'Color','g')
...
plot(time_array, (SA+SB +SC)/3-1/2,'Linewidth',1.5,'Color','k')
hold on;
...
% set(axes1,'XTick',[Tfinalx xlimH],'XTickLabel',{'0','Ts'},'FontName','TimesNewRoman','FontSize',20);
set(axes1,'XTick',[0 Tfinal/2 Tfinal],'XTickLabel',{'0','180','360'},'FontName','TimesNewRoman','FontSize',20);
set(axes1,'YTick',[-0.5 -0.16 0.16 0.5],'FontName','TimesNewRoman','FontSize',20);
% ylim([0 1])
...
hold(axes1,'off');
% Set the remaining axes properties
set(axes1,'XTick',[Tfinalx xlimH],'XTickLabel',{'0','T_s'},'FontName','TimesNewRoman','FontSize',20);
% set(axes1,'YTick',[-1.5 -0.5 0 1 1.5 2.5],'YTickLabel',{'L','H','L','H','L','H'},'FontName','TimesNewRoman','FontSize',20);
