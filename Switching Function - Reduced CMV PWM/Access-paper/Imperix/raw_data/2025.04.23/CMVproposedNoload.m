...
SDS00001 = readtable("C:\Github\KTH\Switching Function - Reduced CMV PWM\Access-paper\Imperix\raw_data\2025.04.23\SDS00001.csv", opts);
...
set(axes1,'FontName','Times New Roman','FontSize',18,'GridAlpha',0.5,...
    ...
    [-4.78 -4.1 -3 -1 0.072 2.04 3 5],'YTickLabel',...
    {'-16-7','16.7','-50','50','-50','50','-50','50'},'ZMinorGrid','on');
% Create legend
