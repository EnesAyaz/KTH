...
SDS00001 = readtable("C:\Github\KTH\Switching Function - Reduced CMV PWM\Access-paper\Imperix\raw_data\SDS00001.csv", opts);
...
set(axes1,'FontName','Times New Roman','FontSize',16,'GridAlpha',0.5,...
    ...
    [-5.15 -3 -1 0.072 2.04 3 5],'YTickLabel',...
    {'16.7','-50','50','-50','50','-50','50'},'ZMinorGrid','on');
% Create legend
