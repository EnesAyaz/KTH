...
[ Pt_one_leg_cond Pt_one_leg_fs];

Pco=[Pco Pt_one_leg_cond*3];
Psw=[Psw Pt_one_leg_fs*3];
...
plot1 = plot(x,Pco,'MarkerSize',15,'LineWidth',3);
plot2 = plot(x,Psw,'MarkerSize',15,'LineWidth',3);
...
% Create xlabel
xlabel({'The rated voltage of the semiconductor (V)'});
