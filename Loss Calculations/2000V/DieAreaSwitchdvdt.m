Tj=100;
Ptot_y=[];
number_of_parallel_dies_x=1:0.5:40;
fc_x=5e3:0.5e3:30e3;
...
rds=25e-4*(1+(Tj-25)/75);
rds=rds*8/number_of_parallel_dies;
E_zcs= 2e-3;
% E_zcs= 0;
E_zcs=E_zcs*number_of_parallel_dies/8;
...
% Create xline
xline(25,'DisplayName','25 kHz','Parent',axes1,'LineStyle','-.',...
    'Color',[1 1 1],...
    'LineWidth',2);

% Create ylabel
ylabel('Number of Parallel Dies','FontName','Times');
