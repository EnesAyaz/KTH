function [d, vectseq,subsect_uref_dq]=svmc_qrdcl(uref,fi,opt);
%Two-level constrained SVM modulator, version for QRDCL converters with
%distributed capacitive snubbers (classic Malesani)
%
