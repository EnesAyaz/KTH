function [d, vectseq,subsect_uref_dq]=svmc_mirp3(uref,fi,opt);
%Two-level constrained SVM modulator
% MIRPACS 3 variant- uses alternating 3-vector sequences in sectors B,C,F
% and G
%
% [d, vectseq]=svmc_mirp3(Uref,fi, opt);
%
...
% munlock
% mlock;
persistent dmat initd dq2ab optseq odd;
%
%
if opt==1,
    %
